...
module DataPath16BitCpu(Clk,A,B,ALU_Out,PC,Ins,Control,PC_Next,MemToReg_Out,ALUsrc_Out,Caddr);
    input Clk;
    ...
    Memory_16bAddr  #(16'b0010_0000_0001_0010,16'b0000_0011_0100_0101,0)   INST_MEMORY    (PC,1'b1,1'b0,16'b0000_0000_0000_0000,Ins);
    ...
    Reg_File16b             REG_FILE     (A,B,MemToReg_Out,Ins[11:8],Ins[7:4],Caddr,Control[9],1'b1,Clk);
    ...
    Memory_16bAddr          DATA_MEMORY      (ALU_Out,Control[2],Control[7],B,Mem_Out);
